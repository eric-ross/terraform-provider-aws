...
resource "aws_api_gateway_integration_response" "r200IntegrationResponse" {
  depends_on = [aws_api_gateway_integration.S3Integration]
...
# state. Detailed information on the `state move` command can be found in the
# documentation online: https://www.terraform.io/docs/commands/state/mv.html
resource "aws_api_gateway_integration_response" "r400IntegrationResponse" {
  depends_on = [aws_api_gateway_integration.S3Integration]
...
# state. Detailed information on the `state move` command can be found in the
# documentation online: https://www.terraform.io/docs/commands/state/mv.html
resource "aws_api_gateway_integration_response" "r500IntegrationResponse" {
  depends_on = [aws_api_gateway_integration.S3Integration]
